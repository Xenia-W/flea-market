...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      console.log('********* 查询历史订单: nebCall *****************')
      var to = global.contractAddress
      var funcName = "getOrderHistory"
      var para = ""
      window.postMessage({
      ...
      window.addEventListener('message', function(e) {
        ...
        if(curPath !== '/buyhistory')
          return
        console.log("recived by 查询历史订单:" + e + ", e.data:"+ JSON.stringify(e.data))
